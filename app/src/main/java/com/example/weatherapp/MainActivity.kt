...
class MainActivity : AppCompatActivity() {
    ...
    val CITY: String = "São Paulo, Brazil"
    val API: String = "5a94db4e3d2c3e63d52542e65fefb5e5"
    ...
    inner class weatherTask() : AsyncTask<String, Void, String>(){
        ...
        override fun onPreExecute() {
            super.onPreExecute()
            /*This shows the ProgressBar, so the main design is gone*/
